        ...
        <div class="row  bg-secondary rounded justify-content-center mx-0">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded p-4">
                    ...
                    <form action="{{ route('video.update', $posts->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="video" class="form-control" value="{{ $posts->video }}" placeholder="Paste new embeded video link here">
                        </div>
