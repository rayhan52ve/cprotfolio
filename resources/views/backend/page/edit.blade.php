                    ...
                    <form action="{{ route('page.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="category"
                                value="{{ $page->name }}" aria-describedby="category">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="file" name="image" id="category" class="form-control bg-dark"
                                value="{{ $page->image }}" aria-describedby="category" id="file-ip-1" accept="image/*"
                                onchange="showPreview(event);">
                        </div>
                        <div class="mb-3">
                            <img id="file-ip-1-preview"  src="{{ asset($page->image) }}" style="display: block; width: 200px; height: 150px;">
                        </div>
